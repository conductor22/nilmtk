...
def draw_plot(input_data, title="", metergroup=None, lim="", top_k=None):
    ...
    '''
    Einheitliche X-Achse, damit die Beschriftung zur Achsenüberschrift passt
    Wenn rauskommentiert, wird die Beschriftung automatisch erstellt und es kann einfach reingezoomt werden mit
    immer genauerer Auflösung
    '''
...
# draw_plot erzeugt für bestimmtes Szenario falsche Beschriftungen und weil nur noch wenig Zeit -> Kopie und Anpassung 
